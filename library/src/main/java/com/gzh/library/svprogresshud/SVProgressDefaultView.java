package com.gzh.library.svprogresshud;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    private int resBigLoading = com.gzh.library.R.mipmap.ic_svstatus_loading;
    private int resInfo = com.gzh.library.R.mipmap.ic_svstatus_info;
    private int resSuccess = com.gzh.library.R.mipmap.ic_svstatus_success;
    private int resError = com.gzh.library.R.mipmap.ic_svstatus_error;
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(com.gzh.library.R.layout.view_svprogressdefault, this, true);
        ivBigLoading = (ImageView) findViewById(com.gzh.library.R.id.ivBigLoading);
        ivSmallLoading = (ImageView) findViewById(com.gzh.library.R.id.ivSmallLoading);
        circleProgressBar = (SVCircleProgressBar) findViewById(com.gzh.library.R.id.circleProgressBar);
        tvMsg = (TextView) findViewById(com.gzh.library.R.id.tvMsg);
    }
