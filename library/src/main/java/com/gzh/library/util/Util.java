...
public class Util {
    ...
    public static String getScientificCountingMethodAfterData(Double aDouble, Integer scale) {
        ...
        String need = bigDecimal.stripTrailingZeros().toPlainString();
        if (need.contains(".")) {
            need = need + "000000";
            if (scale == 6)
                need = need.substring(0, need.indexOf(".") + 7);
            else if (scale == 2)
                need = need.substring(0, need.indexOf(".") + 3);
        } else {
            if (scale == 6)
                need = need + ".000000";
            else if (scale == 2)
...
//            result = Html.fromHtml("&yen;") + point(d, 2) + "万";
            result = Html.fromHtml("&yen;") + getScientificCountingMethodAfterData(d, 2) + "万";
        } else {
