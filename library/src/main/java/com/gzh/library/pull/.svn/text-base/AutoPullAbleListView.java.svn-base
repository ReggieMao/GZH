...
public class AutoPullAbleListView extends ListView implements AutoPullAble {
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(com.gzh.library.R.layout.view_auto_load_more, null);
        mLoadingView = (ImageView) view.findViewById(com.gzh.library.R.id.loading_icon);
        mLoadingView.setBackgroundResource(com.gzh.library.R.drawable.loading_anim);
